...
public class PythonRunner {
  ...
  public static void runScript (String scriptName) {
    ...
    try {
      ...
      ProcessBuilder pb = new ProcessBuilder("venv/Scripts/python.exe","-u", "src/main/python/" + scriptName);
      ...
      String errLine;
      if (!Objects.equals(firsterror, "Error: Nothing went wrong")) {while ((errLine = errorReader.readLine()) != null) {
