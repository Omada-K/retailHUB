...
# Load data files
orders = pd.read_csv(r"C:\CAPSTONE\retailHUB\data\orders_final_cleaned.csv", delimiter=',')
...
orders["Created At"] = pd.to_datetime(orders["Created At"], dayfirst=True, errors="coerce")
...
#df_report.index = ["Low Value", "High Value"]

#df_report.plot(kind="bar", figsize=(8, 5), colormap="coolwarm")
